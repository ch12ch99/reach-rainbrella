...
export default function AccountAddEdit(props) {
    ...
    return (
        <Dialog open={props.open}>
            ...
            <DialogContent>
                <hr/>
                <TextField label="帳號名稱" InputProps={{startAdornment: (<InputAdornment position="start"><AccountCircle /></InputAdornment>),}}name="account_Name" variant="outlined" value={account.account_Name} onChange={handleChange} /><hr />
                ...
                <TextField label="Password" type="password" name="account_Password" variant="outlined" value={account.account_Password} onChange={handleChange} /><hr />
